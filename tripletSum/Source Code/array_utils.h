...
#ifndef LARGESTNUMBERFORMEDFROMARRAY_ARRAY_UTILS_H
#define LARGESTNUMBERFORMEDFROMARRAY_ARRAY_UTILS_H

#endif //LARGESTNUMBERFORMEDFROMARRAY_ARRAY_UTILS_H


#define MAX_ELEMENT_VALUE 2000

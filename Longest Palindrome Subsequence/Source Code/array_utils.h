 ...
 * @author Idan Damri
 */
#ifndef LARGESTPALINDROMESUBSEQUENCE_ARRAY_UTILS_H
#define LARGESTPALINDROMESUBSEQUENCE_ARRAY_UTILS_H

#endif //LARGESTPALINDROMESUBSEQUENCE_ARRAY_UTILS_H
...
int** initZeroMatrix(int rows, int cols);
int max(int a, int b);
void printIntegerMatrix(int** mat, int rows, int cols);
